...
class NN:
    ...
    def train(self, X_tr: np.ndarray, y_tr: np.ndarray,
        ...
        for i in range(n_epochs):
            ...
            # for the first 5 epochs, print out the weights of parameters 
            # in the first linear layer and the second linear layer
            # print them in the fashion that they should in matrix form
            if i < 1:
                print("Epoch: ", i)
                print("First linear layer weights: ")
                print(self.linear1.W)
                #print("Second linear layer weights: ")
